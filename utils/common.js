...
const rulePrefix = '((#|\\*)?(星铁|星轨|崩铁|星穹铁道|铁道|sr)|\\*|＊)'
...
function statisticsOnlineDateGeneral (powerRecoverList) {
 ...
 function statisticOnlinePeriods (powerRecoverList) {
  // 获取当前日期
  let today = new Date()
